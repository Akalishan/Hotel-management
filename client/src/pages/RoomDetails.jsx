...
export const RoomDetails = () => {
  ...
  const [isAvailable, setIsAvaiilable] = useState(false);
    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 1g:px-24 xl:px-32">
        ...
        <div className="flex flex-col lg:flex-row mt-6 gap-6">
          ...
          <div className="grid grid-cols-2 gap-22 lg:w-1/2 w-full">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div className="flex flex-col">
            <h1 className="text-3xl md:text-4xl font-playfair">
              Experience Luxary Like Never Before
            </h1>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            availability. You get a comfortable Two edroom apartment has a true
