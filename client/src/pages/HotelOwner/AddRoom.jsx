    ...
    <div>
      <form onSubmit={onSubmithandler}>
        <Tittle
          ...
          font="outfit"
          tittle="Add Room"
          subTittle="Fill in the details carefully and accurate room details, pricing, and ameities, to enhance the user booking experience."
        />
        ...
        <p className="text-gray-800 mt-4">Aentnities</p>
